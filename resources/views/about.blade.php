...
<form action="http://temporario.web7073.uni5.net/AtivaCred/About" id="home-refinancing-lead-step-1" method="post">
    <div data-field-name="lead-intended-credit" id="ember586" class="form-group ember-view">
        <div data-error="false" class="form-field form-field--dirty form-group--dirty dirty">
            ...
            <div class="input form-field__input ">
                <input placeholder="NOME COMPLETO" id="ember586-input" class="form-group__text-field input__field ember-view" insp-form-input-id="lead-intended-credit" name="nome">
            </div>
        </div>
    </div>
    <div data-field-name="customer-full-name" id="ember653" class="form-group ember-view">
        <div data-error="false" class="form-field form-field--pristine form-group--pristine pristine">
            ...
            <div class="input form-field__input ">
                <input placeholder="EMAIL" id="email" type="email" class="form-group__text-field input__field ember-view" insp-form-input-id="customer-full-name" name="email">
            </div>
        </div>
    </div>
    <div data-field-name="customer-phone" id="ember670" class="form-group ember-view">
        <div data-error="false" class="form-field form-field--pristine form-group--pristine pristine">
            ...
            <div class="input form-field__input ">
                <select name=""  class="form-group__text-field inspectletIgnore input__field ember-view">
    ...
    <button id="sub" type="submit" data-test="person-info-step-1" class="btn btn--primary btn--fluid">
        SOLICITAR COTAÇÃO
    </button>
</form>
