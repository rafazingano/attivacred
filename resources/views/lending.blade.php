<form id="regForm" action="{{ route('simulacao') }}" method="post">
    @csrf
            ...
            <div data-error="false" class="form-field form-field--dirty ">
                <div data-field-name="lead-intended-credit" id="ember586" class="form-group ember-view">
                    <div data-error="false" class="form-field form-field--dirty form-group--dirty dirty">
                        ...
                        <div class="input form-field__input ">
                            <input value="" placeholder="R$ 0,00" id="valor" class="form-group__text-field input__field ember-view" insp-form-input-id="lead-intended-credit" name="perfil[valor]">
                        </div>
                    </div>
                </div>
                <div data-field-name="customer-full-name" id="ember653" class="form-group ember-view">
                    <div data-error="false" class="form-field form-field--pristine form-group--pristine pristine">
                        ...
                        <div class="input form-field__input ">
                            <input value="" placeholder="Ex: João da Silva Gonçalves" id="nome" class="form-group__text-field input__field ember-view" insp-form-input-id="customer-full-name" name="perfil[nome]">
                        </div>
                    </div>
                </div>
                <div data-field-name="customer-birth-date" id="ember662" class="form-group ember-view">
                    <div data-error="false" class="form-field form-field--pristine form-group--pristine pristine">
                        ...
                        <div class="input form-field__input ">
                            <input placeholder="Ex: 01/02/1990" id="ember662-input" class="form-group__text-field input__field ember-view" insp-form-input-id="customer-birth-date" name="perfil[nascimento]">
                        </div>
                    </div>
                </div>
                <div data-field-name="customer-phone" id="ember670" class="form-group ember-view">
                    <div data-error="false" class="form-field form-field--pristine form-group--pristine pristine">
                        ...
                        <div class="input form-field__input ">
                            <input type="tel" placeholder="Ex: 11 91111 2222" id="ember670-input" class="form-group__text-field inspectletIgnore input__field ember-view" insp-form-input-id="customer-phone" name="perfil[celular]">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="tab">PERFIL DE CRÉDITO
        <div data-field-name="customer-cpf" id="ember708" class="form-group ember-view">
            <div data-error="false" class="form-field form-field--pristine form-group--pristine pristine">
                ...
                <div class="input form-field__input ">
                    <input inputmode="tel" type="text" placeholder="Ex: 111.222.333-44" id="ember708-input" class="form-group__text-field input__field ember-view" insp-form-input-id="customer-cpf" name="perfil[cpf]">
                </div>
            </div>
        </div>
        <div data-field-name="lead-family-monthly-income" id="ember715" class="form-group ember-view">
            <div data-error="false" class="form-field form-field--pristine form-group--pristine pristine">
                ...
                <div class="input form-field__input ">
                    <input inputmode="tel" placeholder="Ex: R$ 3.000,00" id="ember715-input" class="form-group__text-field input__field ember-view" insp-form-input-id="lead-family-monthly-income" name="perfil[renda]">
                </div>
            </div>
        </div>
        <div data-field-name="lead-professional-status" id="ember720" class="form-group ember-view">
            <div data-error="false" class="form-field form-field--pristine form-group--pristine pristine">
                ...
                <div class="input form-field__input ">
                    <div id="ember720-input" class="radio-input input__field ember-view" insp-form-input-id="lead-professional-status" name="lead-professional-status">
                        <div class="radio-input__item">
                            <input type="radio" name="perfil[professional]" id="lead-professional-status-clt" value="clt">
                        ...
                        <div class="radio-input__item">
                            <input type="radio" name="perfil[professional]" id="lead-professional-status-self_employed" value="self_employed">
                        ...
                        <div class="radio-input__item">
                            <input type="radio" name="perfil[professional]" id="lead-professional-status-freelancer" value="freelancer">
                        ...
                        <div class="radio-input__item">
                            <input type="radio" name="perfil[professional]" id="lead-professional-status-businessman" value="businessman">
                        ...
                        <div class="radio-input__item">
                            <input type="radio" name="perfil[professional]" id="lead-professional-status-civil_servant" value="civil_servant">
                        ...
                        <div class="radio-input__item">
                            <input type="radio" name="perfil[professional]" id="lead-professional-status-retired" value="retired">
                        ...
                        <div class="radio-input__item">
                            <input type="radio" name="perfil[professional]" id="lead-professional-status-other" value="other">
            ...
            <div data-error="false" class="form-field form-field--pristine form-group--pristine pristine">
                ...
                <div class="input form-field__input ">
                    <div id="ember738-input" class="radio-input input__field ember-view" insp-form-input-id="lead-purpose" name="lead-purpose">
                        <div class="radio-input__item">
                            <input type="radio" name="perfil[proposito]" id="lead-purpose-debts_payment" value="debts_payment">
                        ...
                        <div class="radio-input__item">
                            <input type="radio" name="perfil[proposito]" id="lead-purpose-investment_in_own_business" value="investment_in_own_business">
                        ...
                        <div class="radio-input__item">
                            <input type="radio" name="perfil[proposito]" id="lead-purpose-real_estate_renovation" value="real_estate_renovation">
                        ...
                        <div class="radio-input__item">
                            <input type="radio" name="perfil[proposito]" id="lead-purpose-goods_acquisition" value="goods_acquisition">
                        ...
                        <div class="radio-input__item">
                            <input type="radio" name="perfil[proposito]" id="lead-purpose-debts_refinancing" value="debts_refinancing">
                        ...
                        <div class="radio-input__item">
                            <input type="radio" name="perfil[proposito]" id="lead-purpose-others" value="others">
    ...
    <div class="tab">SOBRE O IMÓVEL
        <div data-field-name="lead-real-estate-zip-code" id="ember772" class="form-group ember-view">
            <div data-error="false" class="form-field form-field--pristine form-group--pristine pristine">
                ...
                <div class="input form-field__input ">
                    <input type="tel" placeholder="00000-000" id="ember772-input" class="form-group__text-field input__field ember-view" insp-form-input-id="lead-real-estate-zip-code" name="imovel[cep]">
                    <small>
        ...
        <div class="form-group">
            <div data-field-name="lead-real-estate-number" id="ember784" class="ember-view">
                <div data-error="false" class="form-field form-field--pristine form-group--pristine pristine">
                    ...
                    <div class="input form-field__input ">
                        <input placeholder="000" id="ember784-input" class="form-group__text-field input__field ember-view" insp-form-input-id="lead-real-estate-number" name="imovel[number]">
                    </div>
                </div>
            </div>
        ...
        <div data-field-name="lead-real-estate-type" id="ember790" class="form-group ember-view">
            <div data-error="false" class="form-field form-field--pristine form-group--pristine pristine">
                ...
                <div class="input form-field__input ">
                    <div id="ember790-input" class="radio-input input__field radio-input--horizontal-with-icons ember-view" insp-form-input-id="lead-real-estate-type" name="lead-real-estate-type">
                        <div class="radio-input__item">
                            <input type="radio" name="imovel[tipo]" id="lead-real-estate-type-house" value="casa">
                        ...
                        <div class="radio-input__item">
                            <input type="radio" name="imovel[tipo]" id="lead-real-estate-type-apartment" value="apartment">
                        ...
                        <div class="radio-input__item">
                            <input type="radio" name="imovel[tipo]" id="lead-real-estate-type-commercial" value="commercial">
                        ...
                        <div class="radio-input__item">
                            <input type="radio" name="imovel[tipo]" id="lead-real-estate-type-land" value="land">
        ...
        <div id="ember805" class="form-group ember-view"> </div>
        <div data-field-name="lead-real-estate-has-debts" id="ember806" class="form-group ember-view">
            <div data-error="false" class="form-field  ">
                ...
                <div class="input form-field__input ">
                    <div id="ember806-input" class="ember-view">
                        <div class="conditional-fields">
                            <div id="ember812" class="radio-input input__field radio-input--horizontal-with-buttons ember-view">
                                <div class="radio-input__item">
        ...
        <div data-field-name="lead-has-deed" id="ember816" class="form-group ember-view">
            <div data-error="false" class="form-field form-field--pristine form-group--pristine pristine">
                ...
                <div class="input form-field__input ">
                    <div id="ember816-input" class="radio-input input__field radio-input--horizontal-with-buttons ember-view" insp-form-input-id="lead-has-deed" name="lead-has-deed">
                        <div class="radio-input__item">
                            <input type="radio" name="imovel[matricula]" id="lead-has-deed-yes" value="yes">
                        ...
                        <div class="radio-input__item">
                            <input type="radio" name="imovel[matricula]" id="lead-has-deed-no" value="no">
                        ...
                        <div class="radio-input__item">
                            <input type="radio" name="imovel[matricula]" id="lead-has-deed-do_not_know" value="do_not_know">
        ...
        <div id="ember823" class="form-help-component content-out ember-view">
            <p class="form-help-prompt" data-ember-action="" data-ember-action-824="824">
                O que é matrícula?
            </p>
    ...
    <div class="tab">SOBRE SEU VEICULO
        <div id="ember759" class="ember-view">
            <div class="auto-data__specification-fields">
                <div data-field-name="lead-auto-manufacturing-year" id="ember761" class="form-group ember-view">
                    <div data-error="false" class="form-field form-field--dirty form-group--dirty dirty">
                        ...
                        <div class="input form-field__input ">
                            <select id="ember761-input" class="form-group__text-field select input__field ember-view" insp-form-input-id="lead-auto-manufacturing-year" name="carro[ano_fabricacao]">
                                <option>
                                Selecione um item
                                </option>
                                <option value="2019">
                ...
                <div data-field-name="lead-auto-year" id="ember794" class="form-group ember-view">
                    <div data-error="false" class="form-field form-field--dirty form-group--dirty dirty">
                        ...
                        <div class="input form-field__input ">
                            <select id="ember794-input" class="form-group__text-field select input__field ember-view" insp-form-input-id="lead-auto-year" name="carro[ano]">
                                <option>
                                Selecione um item
                                </option>
                                <option value="2001">
                ...
                <div data-field-name="lead-auto-brand" id="ember861" class="form-group ember-view">
                    <div data-error="false" class="form-field form-field--pristine form-group--pristine pristine">
                        ...
                        <div class="input form-field__input ">
                            <select id="ember861-input" class="form-group__text-field select input__field ember-view" insp-form-input-id="lead-auto-brand" name="carro[marca]">
                                <option>
                            Selecione uma opção
                            </option>
